...
console.log("[bhbotlist.xyz]: Admin/CodeShare/Add router loaded.");
...
app.post("/admin/addcode", global.checkAuth, async (req, res) => {
    ...
    client.channels.cache.get(channels.codelog).send(new Discord.MessageEmbed()
        ...
        .setDescription(`The user named **[${req.user.username}](https://bhbotlist.xyz/user/${req.user.id})** added the code named **${rBody['codename']}** to the system.`)
        .addField("Code Link", `https://bhbotlist.xyz/code/${kod}`, true)
