...
console.log("[bhbotlist.xyz]: Admin/CodeShare/Edit router loaded.");
...
app.post("/admin/editcode/:code", global.checkAuth, async (req, res) => {
    ...
    client.channels.cache.get(channels.codelog).send(new Discord.MessageEmbed()
        ...
        .setDescription(`The user named **[${req.user.username}](https://bhbotlist.xyz/user/${req.user.id})** edited the code named **${rBody['codename']}**.`)
